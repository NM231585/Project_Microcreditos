...
export function Functionality({ onNavigate }: FunctionalityProps) {
  ...
  const pasos = [
    {
      ...
      descripcion: "Regístrate en pocos minutos con tus datos básicos y verifica tu identidad de forma segura.",
      icono: (
    ...
    },
    {
      ...
      descripcion: "Sube la documentación necesaria y completa tu información financiera para la evaluación.",
      icono: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-green-600" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" ><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M9.615 20h-2.615a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8" /><path d="M14 19l2 2l4 -4" /><path d="M9 8h4" /><path d="M9 12h2" /></svg>  
      ),
    },
    {
      id: 3,
      titulo: "Solicita tu crédito",
      descripcion: "Elige el monto, el plazo de pago y envía tu solicitud. Recibirás una respuesta en tiempo récord.",
      icono: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      descripcion: "Una vez aprobada, transferimos el dinero directamente a tu cuenta bancaria de inmediato.",
      icono: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <div className="max-w-7xl xl:max-w-8xl 2xl:max-w-[1600px] bg-gray-50 p-6 sm:p-10 md:p-12 lg:p-10 xl:p-8 shadow-2xl rounded-xl mx-auto">
    ...
    >
      <img src={logo} alt="Logo" className="w-50 sm:w-55 md:w-48 lg:w-64 mx-auto mb-3" />
      <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-white max-w-5xl mx-auto">
        Financiamos el futuro del campo. En Vermer apoyamos a emprendedores y productores rurales con microcréditos
        a medida para que sus proyectos nunca dejen de crecer.
      </p>
    </div>
    ...
    <p className="text-center text-gray-700 mb-8 text-base sm:text-lg md:text-xl lg:text-2xl">
      Obtén tu crédito en cuatro sencillos pasos, sin complicaciones ni filas.
    </p>
