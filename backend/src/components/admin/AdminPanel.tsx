...
import { 
  FileText, TrendingUp, LogOut, Eye, 
        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Panel de Evaluador</p>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid sm:grid-cols-4 gap-4 mb-8">
          ...
          <Card className="p-6">
            ...
            <p className="text-3xl text-gray-900">{solicitudesPendientes.length}</p>
          </Card>
          ...
          <Card className="p-6">
            ...
            <p className="text-3xl text-gray-900">{solicitudesAprobadas.length}</p>
          </Card>

          <Card className="p-6">
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-gray-600">Total Desembolsado</span>
              <DollarSign className="w-5 h-5 text-green-600" />
            </div>
            <p className="text-3xl text-gray-900">${totalDesembolsado.toLocaleString()}</p>
          </Card>
        </div>
          ...
          <TabsContent value="solicitudes">
            <Card className="p-6">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h2 className="text-2xl text-gray-900">Bandeja de Solicitudes</h2>
